  ...
  $(document).on("scroll", onScroll);
    ...
    function onScroll(event) {
        ...
        $('#nav-container ul li a').each(function () {
            ...
            //console.log("current header height: " + $('#header').outerHeight());

            var section = $(currLink.attr("href"));
            if (section.position().top - headerHeight <= scrollPos && 
                section.position().top + section.height() + headerHeight > scrollPos) {
                
                if (activeMenuItem) {
                  activeMenuItem.removeClass("menu-active");
                }
                
                activeMenuItem = currLink.parent();
